...
RULES = [
    {
        ...
        "text": (
            ...
            "DEAL\n"
            "Deal 4 cards to each player. If one has maximum one 7 and three picture cards they can call 'dirty laundry', this can be bluffed so be aware. Getting caught costs 1 point as well as a false accusation. \n\n"
            "PLAY\n"
